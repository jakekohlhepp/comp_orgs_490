...
\begin{frame}{Electronics/Engagement Policy}

\begin{wideitemize}
    \item You may use flat electronics in class (phones, tablets, etc.)
    \item Please do not use laptops as this will distract other students.
    
    \item I highly recommend you put your phone away and either:
    \begin{wideitemize}
        \item Listen and ask questions and rely on board work for notes.
        \item Hand write notes.
    \end{wideitemize}
    \item You always have the option of doing the test-only grade scheme and not attending class.
    \item All materials are posted and free for this reason.
\end{wideitemize}

\end{frame}


\begin{frame}{Cold Calling}

\begin{wideitemize}
    \item I will randomly call students to answer questions.
    \item In one grading scheme, participation is 20\% of your grade.
    \item Questions will be about solving models, intuition or the readings.
    \item To be excused, you need to go through the university approved absence process.
    \item This is to democratize engagement!
