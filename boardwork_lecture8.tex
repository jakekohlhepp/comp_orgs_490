...
\[\max_{e_{ij}} \alpha_{ij}+ \beta_{ij} \theta_i e_{ij} - c(e_{ij} )\]
...
Plugging in $e_{ij}$:
\[\max_{\beta_{ij}} \theta_i (1-\beta_{ij}) \beta_{ij}\theta_i (1+\lambda_i m_{ij} ) - \alpha_{ij}= \max_{\beta_{ij}} \theta_i (\beta_{ij}-\beta_{ij}^2) \theta_i (1+\lambda_i m_{ij} ) - \alpha_{ij}\]
Taking the FOC:
...
\[m_{ip}^* = m_{ia}-\frac{8(\alpha_{ip}-\alpha_{ia})}{\lambda_i \theta_i} \]
