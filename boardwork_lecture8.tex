...
\begin{enumerate}
    ...
    \item Output is given by $y=\theta_i e + \epsilon$
...
However, this step does not make sense in this paper because they are running an experiment and ``shocking" the meaning workers get from the job, while ostensibly trying to hold other personnel policies of the firm fixed, including base pay. So they do not assume the firm has extracted all surplus. Instead, they observe that the profit of the firm will be the fraction of output the firm keeps ($1-\beta_{ij}$) less an exogenous (fixed) salary $\alpha_{ij}$. So they skip the middle step and jump straight to profit maximization. The firm's profit is:
