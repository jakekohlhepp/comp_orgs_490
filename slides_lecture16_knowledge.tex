...
\begin{frame}{The Good News of AI: Initial Gift of Knowledge}

\begin{wideitemize}
    \item the initial gift of knowledge the expert gives the apprentice is:
    \[x_0 = \theta + (1-\theta) e^{-1}\]
    \item Because $e>1$, increasing $\theta$ (AI performance) increases the initial gift of knowledge.
    \item At every point, the apprentice knows more!
    \item This does not lift the apprentice's wages because everyone has access to AI! 
\end{wideitemize}

    
\end{frame}
\begin{frame}{The Bad News of AI: The Old Training Model Collapses}
