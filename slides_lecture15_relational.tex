...
\begin{theorem}
    If $  v > \frac{c}{\delta}+  \bar u$, there is a subgame perfect Nash equilibrium with our guessed strategies where the firm offers a high wage as long as the worker has always exerted high effort, and low wage of $w_L^*=0$ otherwise. The worker exerts high effort as long as the firm has always offered at least $w_H^*$, and the worker does not exert high effort otherwise.
\end{theorem}
    \begin{wideitemize}
