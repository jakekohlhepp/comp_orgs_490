...
\title[diss]{Lecture 20: Compensation Based on Education} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{wideitemize}
    \item Suppose we econometrically decompose a person's income:
