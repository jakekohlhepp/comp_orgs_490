...
\title[diss]{Lecture 14: Promotions as Tournaments} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{wideitemize}
    ...
    \end{wideitemize}
    \item \textbf{Tournaments/Promotions:} The possibility of getting a better job internally.
    \begin{wideitemize}
...
\huge Discussion: Bandiera et. al. (2005)
