...
\begin{wideitemize}
    ...
    \item Finally, let output be: $y=\theta_i e$, where note the two changes.\footnote{We can drop noise because the worker is risk neutral.}
