...
\title{Board Work for Lecture 11: Wells Fargo and Multitasking}
...
The firm always sets $\alpha$ to make the worker indifferent to accepting or rejecting. If the set $\alpha$ such that the worker strictly preferred the job, they would be leaving profit on the table as they could lower $\alpha$, increase profit and not impact worker behavior at all.
