...
\begin{wideitemize}
    ...
    \begin{wideitemize}
        \item Salespeople get a discrete bonus when they achieve quota, execs. start getting bonus when they hit a profitability threshold.
    \end{wideitemize}
...
\begin{wideitemize}
    ...
    \item Most rewards are based on just meeting a minimum standard.
